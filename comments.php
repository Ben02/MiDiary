    ...
    <?php if($this->allow('comment')): ?>
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment_form">
                ...
                <?php endif; ?>
                <p><textarea rows="3" cols="50" name="text" placeholder="添加一条评论" required onkeydown="if(event.ctrlKey&&event.keyCode==13){document.getElementById('misubmit').click();return false};" id="comment"><?php $this->remember('text'); ?></textarea></p><p><button type="submit" class="submit" id="misubmit">提交评论(Ctrl+Enter)</button>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<?php HighSlide_Plugin::emoticons(); ?></p>
            </form>
        </div>
    <?php else: ?>
        <p>评论已关闭</p>
